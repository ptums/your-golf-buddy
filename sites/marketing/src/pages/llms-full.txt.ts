...
If you buy the Golf Buddy Pass and enable sync, a copy of your rounds is stored on
the app's server so you can use them on another device. That data is associated
with a random identifier generated on your device — not with your name, email, or
any personal information. You can delete all synced data from the app's settings
at any time.
...
immediately, it is non-refundable except where required by law; if sync is not
working the maker will fix it or refund you.

## Moving devices

The app shows a recovery key you can save. Entering it on a new device restores
your rounds. With the Golf Buddy Pass, sync does this automatically.
